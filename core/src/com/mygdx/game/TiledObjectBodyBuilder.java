...
/**
 * Created by Digilogue on 31/10/2016.
 */
public class TiledObjectBodyBuilder {
    ...
    private static PolygonShape getRectangle(RectangleMapObject rectangleObject) {
        ...
        Vector2 size = new Vector2((rectangle.x + rectangle.width * HALF) / PIXELS_PER_TILE, (rectangle.y + rectangle
                .height * HALF) / PIXELS_PER_TILE);
        polygon.setAsBox(rectangle.width * HALF / PIXELS_PER_TILE, rectangle.height * HALF / PIXELS_PER_TILE, size,
                0.0f);
        return polygon;
    }
    ...
    private static CircleShape getCircle(EllipseMapObject ellipseObject) {
        ...
        circleShape.setPosition(new Vector2((ellipse.x + ellipse.width * HALF) / PIXELS_PER_TILE, (ellipse.y +
                ellipse.height * HALF) / PIXELS_PER_TILE));
        return circleShape;
    }
